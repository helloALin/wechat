...
class AttachmentAction extends UserAction{
	...
	public function files(){
		...
		$music=array(
		'default'=>array('name'=>'默认','files'=>array(array('file'=>'1.mp3','name'=>'汪峰-一起摇摆'),array('file'=>'2.mp3','name'=>'方大同-明天我要嫁给你了'),array('file'=>'3.mp3','name'=>'今天你要嫁给我'), array('file' => '4.mp3', 'name' => 'Extreme - More Than Words'), array('file' => '5.mp3', 'name' => 'Olivia Ong - All Out Of Love'), array('file' => '6.mp3', 'name' => '卡萨布兰卡'))),
		);
