...
class ClassifyAction extends UserAction{
	...
	public function add(){
		include('./app/Lib/ORG/index.Tpl.php');
		include('./app/Lib/ORG/cont.Tpl.php');
	...
	public function del(){
		...
		if(D(MODULE_NAME)->where($where)->delete()){
			...
			$this->success('操作成功',U(MODULE_NAME.'/index',array('fid'=>$this->fid)));
		}else{
			$this->error('操作失败',U(MODULE_NAME.'/index',array('fid'=>$this->fid)));
		}
	}
